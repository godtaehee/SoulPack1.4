        ...
        if (splitted[0].equals("!goto")) {
			...
			"coke",
                    ...
                    if (splitted.length < 2) { //If no arguments, list options.
                        ...
                        mc.dropMessage("horntail, mushmom, griffey, manon, horseman, balrog, zakum, papu, showa, guild, shrine, fm, skelegon, ariant, singapore, crmisonwood, coke, nautilus");
                    } else {
